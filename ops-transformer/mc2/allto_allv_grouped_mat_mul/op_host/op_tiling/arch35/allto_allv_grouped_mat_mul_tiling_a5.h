...
public:
    explicit AlltoAllvGmmTilingA5(gert::TilingContext *context)
        : AlltoAllvGmmTiling(context)
    {}
...
public:
    explicit AlltoAllvGmmTilingStructA5(gert::TilingContext *context)
        : AlltoAllvGmmTilingStruct(context) {};
