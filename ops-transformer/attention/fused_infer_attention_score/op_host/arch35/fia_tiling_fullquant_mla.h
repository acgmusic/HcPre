...
/*!
 * \file fia_tiling_fullquant_mla.h
 * \brief MLA 全量化重构模板 tiling 头文件
 */
#ifndef FIA_TILING_FULLQUANT_MLA_H
#define FIA_TILING_FULLQUANT_MLA_H
...
class FiaTilingFullQuantMlaArch35 : public FiaTilingBase {
public:
    explicit FiaTilingFullQuantMlaArch35(gert::TilingContext *context)
        : FiaTilingBase(context)
    {}
    ~FiaTilingFullQuantMlaArch35() override = default;
...
private:
    ...
    FiaTilingKeyInfoMla tilingKeyInfo_;
    FiaPlatFormInfoMla platformInfo_;
...
#endif // FIA_TILING_FULLQUANT_MLA_H
