...
class MlaPreprocessProto : public testing::TestWithParam<int> {
protected:
...
TEST_P(MlaPreprocessProto, mla_preprocess_infershape_1)
{
...
INSTANTIATE_TEST_SUITE_P(RopeModes, MlaPreprocessProto, testing::Values(0, 1, 2, 3, 4));
