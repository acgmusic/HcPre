...
class mla_preprocess_test : public testing::TestWithParam<bool> {
protected:
...
TEST_P(mla_preprocess_test, test_case_0)
{
...
INSTANTIATE_TEST_SUITE_P(RopeModes, mla_preprocess_test, testing::Bool());
