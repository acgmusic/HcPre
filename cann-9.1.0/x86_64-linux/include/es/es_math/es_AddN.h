...
#ifndef AIR_CXX_COMPILER_GRAPH_EAGER_STYLE_GRAPH_BUILDER_OP_AddN_CPP_H_
#define AIR_CXX_COMPILER_GRAPH_EAGER_STYLE_GRAPH_BUILDER_OP_AddN_CPP_H_
#include <utility>
...
inline EsTensorHolder AddN(const std::vector<EsTensorHolder> & x, int64_t N) {
