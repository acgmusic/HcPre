...
#ifndef AIR_CXX_COMPILER_GRAPH_EAGER_STYLE_GRAPH_BUILDER_OP_Cross_CPP_H_
#define AIR_CXX_COMPILER_GRAPH_EAGER_STYLE_GRAPH_BUILDER_OP_Cross_CPP_H_
#include <utility>
 ...
 *   x2
 */
inline EsTensorHolder Cross(const EsTensorLike & x1, const EsTensorLike & x2, int64_t dim=-65530) {
  ...
  auto out = EsCross(x1.ToTensorHolder(owner_graph_builder).GetCTensorHolder(), x2.ToTensorHolder(owner_graph_builder).GetCTensorHolder(), dim);
  return out;
}
}  // namespace es
}  // namespace ge
