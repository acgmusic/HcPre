...
#ifndef AIR_CXX_COMPILER_GRAPH_EAGER_STYLE_GRAPH_BUILDER_OP_FloorDiv_CPP_H_
#define AIR_CXX_COMPILER_GRAPH_EAGER_STYLE_GRAPH_BUILDER_OP_FloorDiv_CPP_H_
#include <utility>
 ...
 *   x2
 */
inline EsTensorHolder FloorDiv(const EsTensorLike & x1, const EsTensorLike & x2) {
  ...
  auto out = EsFloorDiv(x1.ToTensorHolder(owner_graph_builder).GetCTensorHolder(), x2.ToTensorHolder(owner_graph_builder).GetCTensorHolder());
  return out;
}
}  // namespace es
}  // namespace ge
