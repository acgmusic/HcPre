...
#ifndef AIR_CXX_COMPILER_GRAPH_EAGER_STYLE_GRAPH_BUILDER_OP_Cdist_CPP_H_
#define AIR_CXX_COMPILER_GRAPH_EAGER_STYLE_GRAPH_BUILDER_OP_Cdist_CPP_H_
#include <utility>
 ...
 *   x2
 */
inline EsTensorHolder Cdist(const EsTensorLike & x1, const EsTensorLike & x2, float p=2.000000) {
  ...
  auto out = EsCdist(x1.ToTensorHolder(owner_graph_builder).GetCTensorHolder(), x2.ToTensorHolder(owner_graph_builder).GetCTensorHolder(), p);
  return out;
}
}  // namespace es
}  // namespace ge
