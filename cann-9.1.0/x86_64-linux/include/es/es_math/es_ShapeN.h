...
#ifndef AIR_CXX_COMPILER_GRAPH_EAGER_STYLE_GRAPH_BUILDER_OP_ShapeN_CPP_H_
#define AIR_CXX_COMPILER_GRAPH_EAGER_STYLE_GRAPH_BUILDER_OP_ShapeN_CPP_H_
#include <utility>
 ...
 */
inline std::vector<EsTensorHolder> ShapeN(const std::vector<EsTensorHolder> & x, int64_t y_num, int64_t dtype=3) {
  auto esb_x = TensorsToEsCTensorHolders(x);
  auto out = EsShapeN(esb_x.data(), static_cast<int64_t>(esb_x.size()), y_num, dtype);
