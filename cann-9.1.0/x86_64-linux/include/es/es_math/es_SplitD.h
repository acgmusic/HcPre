...
#ifndef AIR_CXX_COMPILER_GRAPH_EAGER_STYLE_GRAPH_BUILDER_OP_SplitD_CPP_H_
#define AIR_CXX_COMPILER_GRAPH_EAGER_STYLE_GRAPH_BUILDER_OP_SplitD_CPP_H_
#include <utility>
 ...
 */
inline std::vector<EsTensorHolder> SplitD(const EsTensorHolder & x, int64_t y_num, int64_t split_dim, int64_t num_split) {
  auto out = EsSplitD(x.GetCTensorHolder(), y_num, split_dim, num_split);
