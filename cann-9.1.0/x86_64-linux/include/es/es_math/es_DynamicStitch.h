...
#ifndef AIR_CXX_COMPILER_GRAPH_EAGER_STYLE_GRAPH_BUILDER_OP_DynamicStitch_CPP_H_
#define AIR_CXX_COMPILER_GRAPH_EAGER_STYLE_GRAPH_BUILDER_OP_DynamicStitch_CPP_H_
#include <utility>
...
inline EsTensorHolder DynamicStitch(const std::vector<EsTensorHolder> & indices, const std::vector<EsTensorHolder> & x, int64_t N=1) {
