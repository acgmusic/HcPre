...
#ifndef AIR_CXX_COMPILER_GRAPH_EAGER_STYLE_GRAPH_BUILDER_OP_ForeachExpm1_CPP_H_
#define AIR_CXX_COMPILER_GRAPH_EAGER_STYLE_GRAPH_BUILDER_OP_ForeachExpm1_CPP_H_
#include <utility>
 ...
 */
inline std::vector<EsTensorHolder> ForeachExpm1(const std::vector<EsTensorHolder> & x, int64_t y_num) {
  auto esb_x = TensorsToEsCTensorHolders(x);
  auto out = EsForeachExpm1(esb_x.data(), static_cast<int64_t>(esb_x.size()), y_num);
