...
#ifndef AIR_CXX_COMPILER_GRAPH_EAGER_STYLE_GRAPH_BUILDER_OP_ForeachCosh_CPP_H_
#define AIR_CXX_COMPILER_GRAPH_EAGER_STYLE_GRAPH_BUILDER_OP_ForeachCosh_CPP_H_
#include <utility>
 ...
 */
inline std::vector<EsTensorHolder> ForeachCosh(const std::vector<EsTensorHolder> & x, int64_t y_num) {
  auto esb_x = TensorsToEsCTensorHolders(x);
  auto out = EsForeachCosh(esb_x.data(), static_cast<int64_t>(esb_x.size()), y_num);
