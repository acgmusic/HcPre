...
#ifndef AIR_CXX_COMPILER_GRAPH_EAGER_STYLE_GRAPH_BUILDER_OP_BroadcastGradientArgs_CPP_H_
#define AIR_CXX_COMPILER_GRAPH_EAGER_STYLE_GRAPH_BUILDER_OP_BroadcastGradientArgs_CPP_H_
#include <utility>
 ...
 *   x2
 */
inline BroadcastGradientArgsOutput BroadcastGradientArgs(const EsTensorLike & x1, const EsTensorLike & x2) {
  ...
  auto out = EsBroadcastGradientArgs(x1.ToTensorHolder(owner_graph_builder).GetCTensorHolder(), x2.ToTensorHolder(owner_graph_builder).GetCTensorHolder());
