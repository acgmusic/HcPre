...
typedef enum {
    ...
    HI_PIXEL_FORMAT_YVU_PACKED_420_TILE = 45,
    ...
    HI_PIXEL_FORMAT_VUY_PACKED_444 = 150,

    HI_PIXEL_FORMAT_RAW12_PLANAR = 180,
    HI_PIXEL_FORMAT_RAW12_BAYER_RGGB = 181,
    HI_PIXEL_FORMAT_RAW12_BAYER_GRBG = 182,
    HI_PIXEL_FORMAT_RAW12_BAYER_GBRG = 183,
    HI_PIXEL_FORMAT_RAW12_BAYER_BGGR = 184,
...
typedef struct {
    ...
    hi_void* ATTRIBUTE data;      /* addr of bitmap's data */
} hi_bmp;
