...
#ifndef ACLNN_GROUPED_DYNAMIC_BLOCK_QUANT_H_
#define ACLNN_GROUPED_DYNAMIC_BLOCK_QUANT_H_
...
/* funtion: aclnnGroupedDynamicBlockQuantGetWorkspaceSize
 * parameters :
 * x : required
 * groupList : required
 * minScale : optional
...
/* funtion: aclnnGroupedDynamicBlockQuant
 * parameters :
