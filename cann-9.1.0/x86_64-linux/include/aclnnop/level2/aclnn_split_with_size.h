 ...
 * @param [in] self: npu
 * device侧的aclTensor，数据类型支持FLOAT、FLOAT16、DOUBLE、INT32、UINT32、INT64、UINT64、INT16、UINT16、INT8、UINT8、
 * BFLOAT16、BOOL、COMPLEX128和COMPLEX64。支持非连续的Tensor，数据格式支持ND。
 ...
 * INT32、UINT32、INT64、UINT64、INT16、UINT16、INT8、UINT8、BFLOAT16、BOOL、COMPLEX128和COMPLEX64。支持，数据格式支持ND。
