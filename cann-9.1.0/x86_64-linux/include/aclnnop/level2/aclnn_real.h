 ...
 * 数据类型支持FLOAT、FLOAT16、COMPLEX32、COMPLEX64（ascend950）；
 * ASCEND910B / ASCEND910_93 额外支持 COMPLEX128（输出 DOUBLE）。数据格式支持ND，支持非连续的Tensor。
 * @param [in] out: real计算的出参。npu device侧的aclTensor,
 * 数据类型支持FLOAT、FLOAT16（ascend950）；910B/910_93 额外支持 DOUBLE。数据格式支持ND，支持非连续的Tensor。
