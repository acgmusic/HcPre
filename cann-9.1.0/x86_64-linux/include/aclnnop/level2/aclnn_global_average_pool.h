 ...
 */
ACLNN_API aclnnStatus aclnnGlobalAveragePoolGetWorkspaceSize(
...
aclnnGlobalAveragePool(void* workspace, uint64_t workspaceSize, aclOpExecutor* executor, const aclrtStream stream);
