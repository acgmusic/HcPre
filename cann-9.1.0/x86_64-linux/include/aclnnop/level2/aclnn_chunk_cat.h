...
/**
 * @brief aclnnChunkCat的第一段接口，根据具体的计算流程，计算workspace大小。
...
/**
 * @brief aclnnChunkCat的第二段接口，用于执行计算。
 */
ACLNN_API aclnnStatus
aclnnChunkCat(void* workspace, uint64_t workspaceSize, aclOpExecutor* executor, aclrtStream stream);

#ifdef __cplusplus
}
#endif

#endif // OP_API_INC_CHUNK_CAT_H_
